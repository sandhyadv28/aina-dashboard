...
import type { DateRangePickerProps, QuickSelectOption } from "./types";
import { quickSelectOptions } from "./constants";
import { Button } from "./button";

// Calendar helper functions - Exportable for reuse
...
// Calendar Component - Exportable for reuse
export const CalendarComponent = ({ 
  ...
  for (let day = 1; day <= daysInMonth; day++) {
    const isSelected = false; // You can add logic to check if this day is selected
    days.push(
      <button
        key={day}
