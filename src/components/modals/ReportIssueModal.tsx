        ...
        <div className="glass-card rounded-lg border bg-card text-card-foreground shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="p-6 pt-0 space-y-6">
            ...
            <div>
              ...
              <div
                className="mt-2 border-2 border-dashed border-border rounded-lg p-4 text-center cursor-pointer hover:border-primary/50 hover:bg-accent/10 transition-colors"
